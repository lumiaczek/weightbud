<script lang="ts">
	...
	const checkBeforeSend = () => {
		...
		if(personData.name === '' || personData.weight === '' || personData.gender === '' || personData.height === ''){
			return;
		}
...
<page actionBarHidden={true}>
	...
	<gridLayout columns="45, *" rows="45, *" class="w-full h-screen bg-main pt-3 px-2">
			...
			>
				...
				<button class="rounded-3xl bg-red-500 mx-auto text-center px-4 py-2 my-8 w-3/4" on:tap={checkBeforeSend}>
					<formattedString>
